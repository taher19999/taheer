...
_HOME_A = "مرحبًا {} .. !!\n مرحبًا بك في {}.!\n\nبإستخدام هذا البوت تستطيع تحويل الصور الي PDF ,تضغط ملفات الPDF ,وأيضا تستطيع تقسيم،دمج ،تشفير،فك تشفير ملفات الPDF بالاضافه لإمكانية تدوير صفحات ملفات الPDF,ويمكنك دمج سلايدين وغيرها الكثير\n\n ببساطة ارسل لي ملف PDF او صورة وحدد الاجراء المطلوب وسيقوم بتنفيذه ، لطلب المساعدة في اي وقت اختر  ⚠️ مساعدة ⚠️   . بوت ملفات الPDF موجود لجعل حياتك اسهل  ..\n\n فقط ارسل لي ملفاتك وجرب"
_HOME_B = "الإعدادات ⚙️\n\n اسم المستخدم: {}\n معرّف المستخدم: {}\n اسم المستخدم: {}\n تاريخ التسجيل: {}\n\n اللغة: {}\n الواجهة: {}\n العدد: {}\n العرض: {}\n اسم الملف: {}"
...
_BIG = "بسبب التحميل الزائد لضمان استمرار البوت بعمل ، قيد مطور البوت البوت ل  {} ميغابايت لملفات pdf 🙇\n\n` الرجاء إرسال ملف أقل من {} ميغابايت الحجم` 🙃"
...
BAN = {
    ...
    "banCB" : {_CREATE_BOT : f"{settings.SOURCE_CODE}", _SOURCE : f"{settings.SOURCE_CODE}", _CHANNEL : "https://t.me/ta_ja199"}}
PDF_MESSAGE = {
    ...
    "all_pdf_button" : { _META[1:] : "#metadata", _PREVIEW[1:] : "#preview", _ENCRYPT[1:] : "#encrypt", _DECRYPT[1:] : "#decrypt",
        ...
        _ROTATE[1:] : "pdf|rotate", _FORMAT[1:] : "pdf|format", _ADD_PG[1:] : "add_page", _DEL_PG[1:] : "#deletePg",
...
BUTTONS = {
    ...
    "stamp" : { _B_STAMP : "nabilanavab", "Not For Public Release 🤧" : "pdf|stp|10", "For Public Release 🥱" : "pdf|stp|8",
        "مؤتمن 🤫" : "pdf|stp|2", "الإدارات 🤝" : "pdf|stp|3", "تجريبي 🔬" : "pdf|stp|4", "منتهي 🐀" : "pdf|stp|5",
        "أخير 🔧" : "pdf|stp|6", "للتعليق 🗯️" : "pdf|stp|7", "غير مقبول 😒" : "pdf|stp|9", "موافقة 🥳" : "pdf|stp|0",
        "مُباع ✊" : "pdf|stp|11", "سري للغاية 😷" : "pdf|stp|12", "Draft 👀" : "pdf|stp|13", "AsIs 🤏" : "pdf|stp|1", _BACK : "pdf"},
    "stampA" : { _STAMP_COLOR : "nabilanavab", "Red ❤️" : "#spP|{}|r", "أزرق 💙" : "#spP|{}|b", "أخضر 💚" : "#spP|{}|g", "أصفر 💛" : "#spP|{}|c1",
        "بنفسجي 💜" : "#spP|{}|c2", "أخضر فاتح 💚" : "#spP|{}|c3", "أبيض 🤍" : "#spP|{}|c4", "Black 🖤" : "#spP|{}|c5", _BACK : "pdf|stp" }}
